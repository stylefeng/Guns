...
INSERT INTO `api_resource` VALUES (1405821024314998786, 1405820842689052674, 'GET', '修改个人密码', 'guns$customer_info$update_password', NULL, NULL, NULL, 2.00, NULL, NULL, NULL, NULL);
...
INSERT INTO `api_resource` VALUES (1405821056158154754, 1405820842689052674, 'GET', '修改个人头像', 'guns$customer_info$update_avatar', NULL, NULL, NULL, 3.00, NULL, NULL, NULL, NULL);
...
INSERT INTO `api_resource_field` VALUES (1405821024314998787, 1405821024314998786, 'request', NULL, 'newPassword', 'string', 'Y', '新密码不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821024314998788, 1405821024314998786, 'request', NULL, 'customerId', 'string', 'Y', '用户id不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821024314998789, 1405821024314998786, 'request', NULL, 'oldPassword', 'string', 'Y', '原密码不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821024314998791, 1405821024314998786, 'response', NULL, 'data', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821024314998792, 1405821024314998786, 'response', NULL, 'success', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821024314998793, 1405821024314998786, 'response', NULL, 'code', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821024314998794, 1405821024314998786, 'response', NULL, 'message', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821056170737667, 1405821056158154754, 'request', NULL, 'avatar', 'string', 'Y', '用户头像', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821056170737668, 1405821056158154754, 'request', NULL, 'customerId', 'string', 'Y', '用户id不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821056170737670, 1405821056158154754, 'response', NULL, 'data', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821056170737671, 1405821056158154754, 'response', NULL, 'message', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821056170737672, 1405821056158154754, 'response', NULL, 'code', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821056170737673, 1405821056158154754, 'response', NULL, 'success', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821131194253319, 1405821040807002114, 'request', '主键id', 'customerId', 'string', 'Y', '主键id不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821131194253326, 1405821040807002114, 'response', NULL, 'code', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821131194253327, 1405821040807002114, 'response', NULL, 'data', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821131194253328, 1405821040807002114, 'response', NULL, 'success', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405821131194253329, 1405821040807002114, 'response', NULL, 'message', 'string', 'N', '', NULL, NULL, NULL, NULL);
