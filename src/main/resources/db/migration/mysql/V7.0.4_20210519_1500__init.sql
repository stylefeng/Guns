...
INSERT INTO `api_resource_field` VALUES (1405791882202775554, 1405791882135666690, 'request', NULL, 'token', 'string', 'N', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405791882202775555, 1405791882135666690, 'response', NULL, 'message', 'string', 'N', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405791882202775556, 1405791882135666690, 'response', NULL, 'success', 'string', 'N', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405791882202775557, 1405791882135666690, 'response', NULL, 'data', 'string', 'N', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405791882202775558, 1405791882135666690, 'response', NULL, 'code', 'string', 'N', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823399977263110, 1405821040807002114, 'request', '主键id', 'customerId', 'string', 'Y', '主键id不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823399985651721, 1405821040807002114, 'response', NULL, 'message', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823399985651722, 1405821040807002114, 'response', NULL, 'success', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823399985651723, 1405821040807002114, 'response', NULL, 'data', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823399985651724, 1405821040807002114, 'response', NULL, 'code', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095489, 1405821024314998786, 'request', NULL, 'customerId', 'string', 'Y', '用户id不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095490, 1405821024314998786, 'request', NULL, 'newPassword', 'string', 'Y', '新密码不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095492, 1405821024314998786, 'request', NULL, 'oldPassword', 'string', 'Y', '原密码不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095493, 1405821024314998786, 'response', NULL, 'success', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095494, 1405821024314998786, 'response', NULL, 'data', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095495, 1405821024314998786, 'response', NULL, 'message', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823441484095496, 1405821024314998786, 'response', NULL, 'code', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823465794281474, 1405821056158154754, 'request', NULL, 'customerId', 'string', 'Y', '用户id不能为空', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823465794281476, 1405821056158154754, 'request', NULL, 'avatar', 'string', 'Y', '用户头像', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823465794281478, 1405821056158154754, 'response', NULL, 'message', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823465794281479, 1405821056158154754, 'response', NULL, 'data', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823465794281480, 1405821056158154754, 'response', NULL, 'success', 'string', 'N', '', NULL, NULL, NULL, NULL);
INSERT INTO `api_resource_field` VALUES (1405823465794281481, 1405821056158154754, 'response', NULL, 'code', 'string', 'N', '', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_config` VALUES (1350666094452482049, '获取XSS排除过滤的url范围', 'SYS_XSS_URL_EXCLUSIONS', '/sysNotice/add,/sysNotice/edit,/databaseInfo/add,/apiResource/record,/projectCiTemplate/*', 'Y', '', 1, 'sys_config', 'N', '2021-01-17 12:47:46', 1339550467939639299, '2021-03-04 22:14:14', 1339550467939639299);
...
INSERT INTO `sys_config` VALUES (1356246056131649538, 'websocket的ws-url', 'WEB_SOCKET_WS_URL', 'ws://localhost:8080/webSocket/{userId}', 'Y', '', 1, 'sys_config', 'N', '2021-02-01 22:20:32', 1339550467939639299, NULL, NULL);
